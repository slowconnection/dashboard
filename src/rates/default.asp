                        ...
                        <table id="results-table" class="table table-striped table-light table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" id="sort_FromDate" data-label="FromDate" class="col-md-0">From</th>
                                    <th scope="col" id="sort_ToDate" data-label="ToDate" class="col-md-0">To</th>
                                    <th scope="col" id="sort_CurrencyCode" data-label="CurrencyCode" class="col-md-0">Cur</th>

                                    <th scope="col" id="sort_BillingLevel_1" data-label="BillingLevel_1" class="col-md-0 text-end">01</th>
                                    <th scope="col" id="sort_BillingLevel_2" data-label="BillingLevel_2" class="col-md-0 text-end">02</th>
                                    <th scope="col" id="sort_BillingLevel_3" data-label="BillingLevel_3" class="col-md-0 text-end">03</th>
                                    <th scope="col" id="sort_BillingLevel_4" data-label="BillingLevel_4" class="col-md-0 text-end">04</th>
                                    <th scope="col" id="sort_BillingLevel_5" data-label="BillingLevel_5" class="col-md-0 text-end">05</th>
                                    <th scope="col" id="sort_BillingLevel_6" data-label="BillingLevel_6" class="col-md-0 text-end">06</th>
                                    <th scope="col" id="sort_BillingLevel_7" data-label="BillingLevel_7" class="col-md-0 text-end">07</th>
                                    <th scope="col" id="sort_BillingLevel_8" data-label="BillingLevel_8" class="col-md-0 text-end">08</th>
                                    <th scope="col" id="sort_BillingLevel_9" data-label="BillingLevel_9" class="col-md-0 text-end">09</th>
                                    <th scope="col" id="sort_BillingLevel_10" data-label="BillingLevel_10" class="col-md-0 text-end">10</th>
                                    <th scope="col" id="sort_BillingLevel_11" data-label="BillingLevel_11" class="col-md-0 text-end">11</th>
                                    <th scope="col" id="sort_BillingLevel_12" data-label="BillingLevel_12" class="col-md-0 text-end">12</th>
                                    <th scope="col" id="sort_BillingLevel_13" data-label="BillingLevel_13" class="col-md-0 text-end">13</th>
                                    <th scope="col" id="sort_BillingLevel_14" data-label="BillingLevel_14" class="col-md-0 text-end">14</th>
                                    <th scope="col" id="sort_BillingLevel_15" data-label="BillingLevel_15" class="col-md-0 text-end">15</th>
                                    <th scope="col" id="sort_BillingLevel_16" data-label="BillingLevel_16" class="col-md-0 text-end">16</th>
