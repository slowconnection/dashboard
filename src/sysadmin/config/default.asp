                        ...
                        <table id="results-table" class="table table-striped table-light table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" id="sort_ConfigName" data-label="ConfigName" class="col-md-0">Name</th>
                                    <th scope="col" id="sort_ConfigValue" data-label="ConfigValue" class="col-md-0">Value</th>
                                    <th scope="col" id="sort_ConfigNotes" data-label="ConfigNotes" class="col-md-0">Notes</th>
                                </tr>
                            </thead>
                                    ...
                                    For i=1 To rs.RecordCount
	                                    If Not rs.EOF Then 
                                            ...
                                            <tr id="<%=rs("ID") %>">
                                                ...
                                                <td class="text-nowrap"><%=rs("ConfigName") %></td>
                                                <td class="text-nowrap"><%=rs("ConfigValue") %></td>
                                                <td class="text-nowrap"><%=rs("ConfigNotes") %></td>
