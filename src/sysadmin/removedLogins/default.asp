        ...
        <main role="main" class="p-1">
            <form method="post" action="default.asp">
                ...
                <div class="container-fluid bg-light">
                    <div class="row p-1">
                        <div class="container p-1 col-sm-12 text-white bg-primary rounded-2"><i class="fas fa-id-card"></i> <%=pageName %></div>
                ...
                <div class="row p-1">
                    ...
                    <div class="results-element container-fluid p-1 table-responsive">
                        <table id="results-table" class="table table-striped table-light table-hover">
                            <thead>
                                <tr>
                                    <th scope="col" id="sort_UsernameId" data-label="UsernameId" class="col-md-0">ID</th>
                                    <th scope="col" id="sort_FullName" data-label="FullName" class="text-nowrap">Name</th>
                                    <th scope="col" id="sort_RevRegion" data-label="RevRegion" class="text-nowrap">Rev Region</th>
                                    <th scope="col" id="sort_Capability" data-label="Capability" class="text-nowrap">Capability</th>
                                    <th scope="col" id="sort_Subcapability" data-label="Subcapability" class="text-nowrap">Sub-capability</th>

                                    <th scope="col" id="sort_RemovedDate" data-label="RemovedDate" class="text-nowrap">Removed</th>
                                </tr>
                            </thead>
                                    ...
                                    For i=1 To rs.RecordCount
	                                    If Not rs.EOF Then 
                                            ...
                                            <tr id="<%=rs("id") %>">
                                                ...
                                                <td class="text-nowrap"><%=rs("consultCapability") %></td>
                                                <td class="text-nowrap"><%=rs("SalesTeamName") %></td>

                                                <td class="text-nowrap"><%=rs("removedDatetime") %></td>
