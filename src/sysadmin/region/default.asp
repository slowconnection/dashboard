    ...
    <div class="container-fluid p-0">
        ...
        <main role="main" class="p-1">
            <form method="post" action="default.asp">
                ...
                <div class="container-fluid bg-success text-white p-1 rounded-2"><i class="bi bi-pin-map-fill"></i> <%=pageName %></div>
                        ...
                        <table id="results-table" class="table table-striped table-light table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" id="sort_regionDeliveryLeaderName" data-label="regionDeliveryLeaderName" class="col-md-0">Delivery Lead</th>
                                    <th scope="col" id="sort_regionSalesLeaderName" data-label="sort_regionSalesLeaderName" class="col-md-0">Sales Lead</th>
                                    <th scope="col" id="sort_regionSolutioningLeaderName" data-label="sort_regionSolutioningLeaderName" class="col-md-0">Sol Lead</th>
                                    <th scope="col" id="sort_regionOfferingLeaderName" data-label="sort_regionOfferingLeaderName" class="col-md-0">ROL</th>
                                    <th scope="col" id="sort_flgInactive" data-label="flgInactive" class="col-md-0">Active</th>
                                    <th scope="col" id="sort_flgIncludeInSolutioningEmails" data-label="flgIncludeInSolutioningEmails" class="col-md-0">Sol Emails</th>
                                </tr>
                            </thead>
                            ...
                            %>
                                <tbody class="results-body">
                                    ...
                                    For i=1 To rs.RecordCount
	                                    If Not rs.EOF Then 
                                            flgActive = "<i class='bi bi-dash-square-dotted text-black-50'></i>"
                                            flgSolutioningEmails = "<i class='bi bi-dash-square-dotted text-black-50'></i>"
                                            IF rs("flgInactive") = 0 Then flgActive = "<i class='bi bi-check-square-fill text-success'></i>"
                                            IF rs("flgIncludeInSolutioningEmails") = 1 Then flgSolutioningEmails = "<i class='bi bi-check-square-fill text-success'></i>"

                                            %>
                                            <tr id="<%=rs("ID") %>">
                                                <th scope="row"><%=rs("ID") %></th>
                                                <td class="text-nowrap"><%=rs("RegionName") %></td>
                                                <td class="text-nowrap"><%=rs("regionDeliveryLeaderName") %></td>
                                                <td class="text-nowrap"><%=rs("regionSalesLeaderName") %></td>
                                                <td class="text-nowrap"><%=rs("regionSolutioningLeaderName") %></td>
                                                <td class="text-nowrap"><%=rs("regionOfferingLeaderName") %></td>
                                                <td class="text-nowrap"><%=flgActive %></td>
                                                <td class="text-nowrap"><%=flgSolutioningEmails %></td>
                                            </tr>
                                            <%
                                            rs.MoveNext
                                        End If
