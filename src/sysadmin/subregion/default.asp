                        ...
                        <table id="results-table" class="table table-striped table-light table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" id="sort_SubRegionName" data-label="SubRegionName" class="col-md-0">Sub-region</th>
                                    <th scope="col" id="sort_AccountGroupName" data-label="AccountGroupName" class="col-md-0">Account Group</th>
                                    <th scope="col" id="sort_SubRegionLeaderName" data-label="SubRegionLeaderName" class="col-md-0">Sub-region Lead</th>
                                    <th scope="col" id="sort_SubRegionSolutioningLeaderName" data-label="SubRegionSolutioningLeaderName" class="col-md-0">Sol Lead</th>
                                    ...
                                    For i=1 To rs.RecordCount
	                                    If Not rs.EOF Then 
                                            ...
                                            <tr id="<%=rs("ID") %>">
                                                ...
                                                <td class="text-nowrap"><%=rs("SubRegionName") %></td>
                                                <td class="text-nowrap"><%=rs("AccountGroupName") %></td>
                                                <td class="text-nowrap"><%=rs("SubRegionLeaderName") %></td>
                                                <td class="text-nowrap"><%=rs("SubRegionSolutioningLeaderName") %></td>
