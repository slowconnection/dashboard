...
<%
    ...
    cmd.CommandText = "Forecast_Totals"
    ...
    For ix = 1 To Request.Form.Count
        ...
        If strKey = "filter_accountGroup_id" or strKey = "filter_region_id" or strKey = "filter_subregion_id" or strKey = "filter_header_id" or strKey = "filter_masterPeriod"  or strKey = "filter_dealSize" or strKey = "filter_sellerUsername_id" Then
            If strValue <> "" Then
                strFieldName = "@" & strKey
