    ...
    <div class="container-fluid p-0">
        ...
        <main role="main" class="p-1">
            <form method="post" action="default.asp">
                ...
                <div class="container-fluid bg-dark-subtle text-dark p-1 rounded-2"><i class="bi bi-dice-5"></i> <%=pageName %></div>
                        ...
                        <table id="results-table" class="table table-striped table-light table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" id="sort_CampaignName" data-label="CampaignName" class="col-md-0">Campaign Name</th>
                                    <th scope="col" id="sort_CampaignCapabilityName" data-label="CampaignCapabilityName" class="col-md-0">Offering</th>
                                    <th scope="col" id="sort_CampaignOwnerName" data-label="CampaignOwnerName" class="col-md-0">Owner</th>
                                    ...
                                    For i=1 To rs.RecordCount
	                                    If Not rs.EOF Then 
                                            ...
                                            <tr id="<%=rs("id") %>">
                                                ...
                                                <td class="text-nowrap"><%=rs("campaignName") %></td>
                                                <td class="text-nowrap"><%=rs("campaignCapabilityName") %></td>
                                                <td class="text-nowrap"><%=rs("campaignOwnerName") %></td>
