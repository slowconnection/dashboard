    ...
    <div class="container-fluid p-0">
        ...
        <main role="main" class="p-1">
            <form method="post" action="default.asp">
                ...
                <div class="container-fluid bg-primary text-white p-1 rounded-2"><i class="bi bi-people"></i> <%=pageName %></div>
                ...
                <div class="container col-sm-2 buttons-element justify-content-center btn-group" role="group" aria-label="Buttons">
                        ...
                        <button type="button" id="excel-button" class="btn btn-success btn-sm"><i class="bi bi-box-arrow-down"> excel</i></button>
                </div>
            </form>
                                ...
                                <tbody class="results-body">
                                    ...
                                    For i=1 To rs.RecordCount
	                                    If Not rs.EOF Then 
                                            ...
                                            %>
                                            <tr id="<%=rs("Id") %>">
                                                <td scope="row"><%=FormatDateTime(rs("askDate"),vbShortDate) %></td>
