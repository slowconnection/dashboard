...
export default class CostStackDrilldownQtr extends DrilldownBase {
    ...
    async build() {
        try {
            ...
            let structure = {
                CostStack7: { width: "15%", cellClass: "" },
                CostStack9: { width: "30%", cellClass: "" },
                Q1: { width: "10%", cellClass: "r", special: "," },
                Q2: { width: "10%", cellClass: "r", special: "," },
                Q3: { width: "10%", cellClass: "r", special: "," },
                Q4: { width: "10%", cellClass: "r", special: "," },
